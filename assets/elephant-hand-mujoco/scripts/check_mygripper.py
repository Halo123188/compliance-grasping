...
def main() -> None:
    ...
    hm = hand.compile()
    print(f"nq={hm.nq} nv={hm.nv} nu={hm.nu} nbody={hm.nbody} njnt={hm.njnt} nmesh={hm.nmesh}")
    ...
    attached = [n for n in _names(m, mujoco.mjtObj.mjOBJ_BODY, m.nbody) if "base_step" in (n or "")]
